...
OmrucPoisonArrow = MagicDamageObject(attackType, animationEffect, hitEffect, damageEffect, animationColor, offensive, drawblood, 0, 0)

function onCast(cid, creaturePos, level, maglv, var)
centerpos = {x=creaturePos.x, y=creaturePos.y, z=creaturePos.z}

OmrucPoisonArrow.minDmg = 1
OmrucPoisonArrow.maxDmg = 400

return doTargetMagic(cid, centerpos, OmrucPoisonArrow:ordered())
end
