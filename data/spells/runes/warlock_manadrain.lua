...
WarlockManaDrain = MagicDamageObject(attackType, animationEffect, hitEffect, damageEffect, animationColor, offensive, drawblood, 0, 0)

function onCast(cid, creaturePos, level, maglv, var)
	centerpos = {x=creaturePos.x, y=creaturePos.y, z=creaturePos.z}

	WarlockManaDrain.minDmg = 45
	WarlockManaDrain.maxDmg = 80

	return doTargetMagic(cid, centerpos, WarlockManaDrain:ordered())
end
