...
OmrucBurstArrow = MagicDamageObject(attackType, animationEffect, hitEffect, damageEffect, animationColor, offensive, drawblood, 0, 0)

function onCast(cid, creaturePos, level, maglv, var)
centerpos = {x=creaturePos.x, y=creaturePos.y, z=creaturePos.z}

OmrucBurstArrow.minDmg = 1
OmrucBurstArrow.maxDmg = 400

return doTargetMagic(cid, centerpos, OmrucBurstArrow:ordered())
end
